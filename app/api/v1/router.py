...
from app.api.v1.endpoints import (admin_daily_checkin, admin_dc_accounts,
                                  admin_drivers, admin_producers, auth,
                                  calculator, countries, daily_checkin,
                                  delivery_lists, delivery_orders,
                                  delivery_point_suggestions, delivery_points,
                                  delivery_templates, distribution_centers,
                                  driver, driver_auth, producer, producer_sku,
                                  product_category, dc, dc_auth, regions,
                                  sectors, settlements, tags, temperature_mode,
                                  tutorials)

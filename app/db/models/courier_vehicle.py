...
class CourierVehicle(Base):
    """Courier vehicle (1..N per courier, max 3)."""

    __tablename__ = "courier_vehicles"
    __table_args__ = (Index("ix_courier_vehicles_courier_id_is_active", "courier_id", "is_active"),)
    ...
    courier: Mapped["CourierAccount"] = relationship("CourierAccount", back_populates="vehicles")
    ...
    def __repr__(self) -> str:
        return f"<CourierVehicle(id={self.id}, plate_number='{self.plate_number}', courier_id={self.courier_id})>"

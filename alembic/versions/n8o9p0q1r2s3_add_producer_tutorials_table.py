...
def upgrade() -> None:
    ...
    # Create producer_tutorials table
    op.create_table(
        'producer_tutorials',
...
def downgrade() -> None:
    ...
    # Remove show_tooltips from geo_users
